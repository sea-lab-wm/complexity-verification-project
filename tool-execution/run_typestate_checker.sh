...
java -jar checker-framework-3.14.0/checker/dist/checker.jar -classpath jatyc.jar:"${DATASET6CP}" -processor jatyc.JavaTypestateChecker dataset6/src/main/java/*.java -d classes -Awarns -Xmaxwarns 10000 2> data/typestate_checker_output_cog_dataset_6.txt
java -jar checker-framework-3.14.0/checker/dist/checker.jar -classpath jatyc.jar:"${DATASET6CP}" -processor jatyc.JavaTypestateChecker dataset6/src/main/java/weka/estimators/*.java -d classes -Awarns -Xmaxwarns 10000 2>> data/typestate_checker_output_cog_dataset_6.txt
java -jar checker-framework-3.14.0/checker/dist/checker.jar -classpath jatyc.jar:"${DATASET6CP}" -processor jatyc.JavaTypestateChecker dataset6/src/main/java/weka/gui/beans/*.java -d classes -Awarns -Xmaxwarns 10000 2>> data/typestate_checker_output_cog_dataset_6.txt
java -jar checker-framework-3.14.0/checker/dist/checker.jar -classpath jatyc.jar:"${DATASET6CP}" -processor jatyc.JavaTypestateChecker dataset6/src/main/java/weka/gui/experiment/*.java -d classes -Awarns -Xmaxwarns 10000 2>> data/typestate_checker_output_cog_dataset_6.txt
