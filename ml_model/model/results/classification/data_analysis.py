...
metrics = { 'f1_positive': ['f1_positive_c','f1_positive_cw'], 
            'f1_weighted': ['f1_weighted_c', 'f1_weighted_cw'], 
            'f1_negative': ['f1_negative_c', 'f1_negative_cw'], 
            'precision_positive': ['precision_positive_c','precision_positive_cw'],
            'precision_weighted': ['precision_weighted_c','precision_weighted_cw'],
            'precision_negative': ['precision_negative_c','precision_negative_cw'],
            'recall_positive': ['recall_positive_c','recall_positive_cw'],
            'recall_weighted': ['recall_weighted_c','recall_weighted_cw'],
            'recall_negative': ['recall_negative_c','recall_negative_cw'],
            'auc': ['auc_c','auc_cw'], 
            'auc_weighted': ['auc_weighted_c','auc_weighted_cw'],
            'accuracy': ['accuracy_c','accuracy_cw']}
        ...
        for target in targets:
            for warning_feature in warning_features:
                ...
                for metric in metrics.keys():
                    ...
                    ## filter overall results according feature set, warning feature, target, smote value
                    filtered_df = df.query("feature_set == '" + feature_set + "'" + " and iteration == 'overall' and target == '" + target + "'" + " and use_smote == " + str(smote_value) + " and warning_feature =='" + warning_feature + "'")
                    ...
                    c_metric = metrics[metric][0] ## eg. f1_weighted_c
                    cw_metric = metrics[metric][1] ## eg. f1_weighted_cw
                    diff_metric = "diff_" + metric ## eg. diff_f1_weighted
                    ...
                    overall_result_header_across_models['use_smote'] = smote_value 
                ...
                for model in models:
                    ...
                    ## filter overall results according feature set, warning feature, target, smote value and model
                    ...
                    for metric in metrics.keys():
                        ...
                        overall_result_header_model_wise['use_smote'] = smote_value
