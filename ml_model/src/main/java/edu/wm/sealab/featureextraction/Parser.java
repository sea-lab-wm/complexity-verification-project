...
public class Parser {
	public static void main(String[] args) {
		// Snippet splitting
		SnippetSplitter ss = new SnippetSplitter("ml_model/src/main/resources/manually_created_snippets/",
				"ml_model/src/main/resources/snippet_splitter_out/");
		ss.run(new File("simple-datasets/src/main/java/cog_complexity_validation_datasets/One/"), "1",
				"SNIPPET_STARTS");
		ss.run(new File("simple-datasets/src/main/java/cog_complexity_validation_datasets/One/"), "2", "DATASET2START");
		ss.run(new File("simple-datasets/src/main/java/cog_complexity_validation_datasets/Three/"), "3",
				"SNIPPET_STARTS");
