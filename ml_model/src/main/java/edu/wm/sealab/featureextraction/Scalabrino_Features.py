...
SOURCE_DIR = "/Users/nadeeshan/Documents/Spring2023/Feature-Implementation/complexity-verification-project/ml_model/src/main/resources/snippet_identifier_splitter_out/"
NEW_PATH = "ml_model/nmi_data.csv"
nmi_metrics = []
...
def read_all_java_files(directory,nmi_metrics):
...
read_all_java_files(SOURCE_DIR, nmi_metrics)

field_names = ['file', 'NMI', 'NMI (avg)', 'NMI (max)']  
