...
public class FeatureVisitor extends VoidVisitorAdapter<Void> {
    ...
    /**
     * This method identifies boolean literals in a java method and sums them up to the total number of literals
     * 
    ...
    /**
     * This method identifies char literals in a java method and sums them up to the total number of literals
    ...
    /**
     * This method identifies integer literals in a java method and sums them up to the total number of literals
    ...
    /**
     * This method identifies the long literals in a java method and sums them up to the total number of literals
    ...
    /**
     * This method identifies null literals in a java method and sums them up to the total number of literals
    ...
    /**
     * This method identifies string literals in a java method and sums them up to the total number of literals
    ...
    /**
     * This method identifies text block literals in a java method and sums them up to the total number of literals
    ...
    /**
     * This method identifies double literals in a java method and sums them up to the total number of literals
