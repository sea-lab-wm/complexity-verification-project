...
public class ds_3_snip_98_setMapTransform {
   ...
   *
   * @param mt The transform that should be applied to a <code>Tile</code> that is clicked on the
   *     map.
   */
  // SNIPPET_STARTS
  public void setMapTransform(MapTransform mt) {
    ...
    MapControlsAction mca =
        (MapControlsAction) freeColClient.getActionManager().getFreeColAction(MapControlsAction.ID);
