...
def evaluate(model, X_test, y_test, dynamic_epsilon, target):
    ...
    if configs.USE_DS3_CONFIGS:
        if dynamic_epsilon:
            baseline_f1_0, baseline_f1_1, baseline_f1_2, class_0_weight, class_1_weight, class_2_weight= DS3_getBestBaselineModel_epsilon_dynamic(target)
        else:
            baseline_f1_0, baseline_f1_1, baseline_f1_2, class_0_weight, class_1_weight, class_2_weight = DS3_getBestBaselineModel_epsilon_0(target)
        ...
        if dynamic_epsilon:
            baseline_f1_0, baseline_f1_1, baseline_f1_2, class_0_weight, class_1_weight, class_2_weight= Merged_getBestBaselineModel_epsilon_dynamic(target)
        else:
            baseline_f1_0, baseline_f1_1, baseline_f1_2, class_0_weight, class_1_weight, class_2_weight = Merged_getBestBaselineModel_epsilon_0(target)
