...
OUTPUT_RQ1_PATH="featureselection/experiments_DS6_all.jsonl"
...
NOT_USEFUL_FEATURES=["participant_id", "system_name", "file_name", "snippet_signature", "developer_position","PE gen","PE spec (java)"]
...
#                      "readability_level",binary_understandability,correct_verif_questions,gap_accuracy,readability_level_ba,readability_level_before,time_to_read_complete,perc_correct_output,complexity_level,brain_deact_31,warnings_checker_framework,warnings_typestate_checker,warnings_infer,warnings_openjml,warning_sum,method_name,file,New Expression complexity AVG,New Expression complexity MAX,New Expression complexity MIN,New Method chains AVG,New Method chains MAX,New Method chains MIN,NOC (standard),NOC (normalized),
...
## Output file names
KENDALS_OUTPUT_FILE_NAME="featureselection/kendals_features_DS6_all.csv"
MI_OUTPUT_FILE_NAME="featureselection/mutual_info_DS6_all.csv"
