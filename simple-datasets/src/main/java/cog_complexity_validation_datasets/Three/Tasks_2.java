...
public class Tasks_2 {
    ...
    public void runAllSnippets() {
        ...
        close();
        //S50
        actionPerformed(new ActionEvent(new Tasks_2("message"), 1, "blink"));
        //S51
...
//    @Override // Removed to allow compilation
    ...
    private static class BshClassManager {
        @SuppressWarnings("all")
        public static BshClassManager createClassManager(Tasks_2 tasks) {
            throw new Error();
        }
    }
    ...
    private class ActionEvent {
        @SuppressWarnings("all")
        public ActionEvent(Tasks_2 tasks, int eventId, String blink) {
        }
    }
    ...
    @SuppressWarnings("all")
    public Tasks_2(FreeColClient freeColClient, String s, Object o, KeyStroke d) {
    ...
    private class ProgramReceiveTarget {
        @SuppressWarnings("all")
        public ProgramReceiveTarget(Tasks_2 tasks, Object name, Object id) {
        }
    }
